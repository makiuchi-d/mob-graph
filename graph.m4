...
MOB(桜坂しずく, 1, `0001,0188', 演劇部)
MOB(宮下ココ,   1, `0002,0260', ) // ボランティア？
MOB(逢沢遊宇,   1, `0003,0368', ) // 天文部？
MOB(一之瀬マリカ, 2, `0004,0420,0601', )
MOB(結城紗菜,   2, `0005,0429', テニス部)
MOB(西村文絵,   2, `0006,0373,0585', ) // 漫研？
MOB(永山みなみ, 3, `0007,0183,0508', ) // 保育所の手伝い？ボランティア？
MOB(クリスティーナ, 3, `0008,0333', 留学生)
MOB(菊池朱美,   3, `0009,0411', 写真部)
MOB(須田いるか, 1, `0010,0353', 水泳部)
MOB(杉崎亜矢,   1, `0011,0209,0560', 書道部)
MOB(御堂優理,   1, `0012,0268', )
MOB(佐伯麗音,   2, `0013,0244,0596', ) // ダンス？
MOB(鳥居歩美,   2, `0014,0466', ) // お菓子づくり？
MOB(神谷理華,   2, `0015,0391', ) // 科学部？
MOB(森嶋ななか, 3, `0016,0403', 校内新聞)
MOB(九条聖来,   3, `0017,0283', 管弦楽)
MOB(近江彼方,   3, `0018,0181,0534', 保健委員)
MOB(近江遥,     1, `0019,0457,0526', 学級委員)
MOB(下園咲,     1, `0020,0393', チアリーディング)
MOB(田中さち子, 1, `0021,0398,0568', )
MOB(支倉かさね, 2, `0022,0191', コスプレ)
MOB(多々良るう, 2, `0023,0266', )
MOB(篠宮あきる, 2, `0024,0197', フィギュアスケート)
MOB(吉川瑞希,   3, `0025,0471', バスケ部)
MOB(白木凪,     3, `0026,0251,0550', ) // 美術部？
MOB(藤城悠弓,   3, `0027,0275', 管弦楽)
MOB(黒崎隼,     2, `0069,0215', 乗馬クラブ)
MOB(門田剣,     3, `0070,0223', ) //剣道部？
MOB(設楽ふみ,   1, `0074,0273', )
MOB(桐原優香,   2, `0076,0427,0485', 放送部)
MOB(斉木風,     1, `0080,0409', ) // 陸上部？
MOB(坂巻千鶴子, 3, `0084,0199,0532', 風紀委員)
MOB(志賀仁美,   3, `0085,0258,0544', 風紀委員)
MOB(福原命,     1, `0089,0281', 風紀委員)
MOB(鬼崎アキラ, 2, `0091,0323,0603', ) // 自転車屋
MOB(月島結架,   2, `0097,0443', ) // ダンス？
MOB(兵藤さゆり, 3, `0098,0451,0591', 高天原研究所)
MOB(蘭花,       1, `0102,0205', 留学生)
MOB(紫藤美咲,   3, `0106,0359,0582', ) // ビリヤード？
MOB(ラクシャータ, 2, `0120,0325,0566', 留学生)
MOB(レベッカ,   2, `0121,0316,0493', 留学生)
MOB(綾小路姫乃, 2, `0128,0218,0539', 華道部)
MOB(黒羽咲良,   1, `0130,0331,0510', )
MOB(黒羽咲夜,   3, `0135,0348', )
MOB(白瀬小雪,   1, `0140,0310', ) // バレエ？
MOB(相川涼,     3, `0149,0318,0552', 演劇部)
MOB(イザベラ,   3, `0151,0416', 留学生)
MOB(エマ,       3, `0156,0459', 留学生)
MOB(高天原睦月, 1, `0160,0477', 高天原研究所)
MOB(ジェニファー, 2, `0166,0253,0557', 留学生)
MOB(マリア,     1, `0168,0363', 留学生)
MOB(レオ,       2, `0173,0297,0515', 留学生)
MOB(早乙女紫,   1, `0175,0479', )
